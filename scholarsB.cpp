...
int main()
{
   ...
   //-| 0. Display copyright.
   //-|---------------------------------------------------------------------- 
   cout << "\n\n(c) 2021, goodmans0671 Samuel Goodman\n\n";
   cout << "\n\n(c) 2021, jbrown464 Janyhka Brown\n\n";
   cout << "\n\n(c) 2021, jgilbert334 Jarrett Gilbert\n\n";
   ...
   //-|---------------------------------------------------------------------- 
   cout << "\nSTEP 1 ====\n";
   SCHOLAR S1; SCHOLAR S4; SCHOLAR S5; SCHOLAR S6; 
   Show_Scholar(S1, "S1");
